// aarch64 NEON: same per-element linear combination as `x86::sse2`, ported
// 1:1
...
/// One 8x8 inverse CSC. Extracted like `x86::sse2::inverse_one` so a future
/// aarch64 fused decode path can call it per spatial block.
#[inline(always)]
