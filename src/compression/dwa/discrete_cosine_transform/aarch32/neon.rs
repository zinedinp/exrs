// 32-bit ARM NEON: 1:1 port of `x86::sse2`'s "dctInverse8x8_sse2" shape
// row-pass then two 4-lane column-pass halves using the minimal `f32x4`
// primitives
...
// matching the SSE2 tier (and OpenEXR's "DCT_INVERSE_8x8_SS2_ROW_LOOP") exactly.
...
// beta0..beta3 tree-paired, matching the SSE2 tier exactly.
